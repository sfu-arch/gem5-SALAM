; ModuleID = 'pool0.c'
source_filename = "pool0.c"
target datalayout = "e-m:e-p:32:32-Fi8-i64:64-v128:64:128-a:0:32-n32-S64"
target triple = "armv7-pc-none-eabi"

; Function Attrs: nofree norecurse nounwind
define dso_local void @compute([28 x [6 x i32]]* nocapture readonly %poolIn, [14 x [6 x i32]]* nocapture %poolOut) local_unnamed_addr #0 {
entry:
...
for.cond7.preheader:                              ; preds = %for.cond4.preheader, %for.cond7.preheader
  ...
  %arrayidx15.1 = getelementptr inbounds [28 x [6 x i32]], [28 x [6 x i32]]* %poolIn, i32 %h.060, i32 %add13.1, i32 %c.058
  %0 = load i32, i32* %arrayidx15.1, align 4, !tbaa !3
  %arrayidx15 = getelementptr inbounds [28 x [6 x i32]], [28 x [6 x i32]]* %poolIn, i32 %h.060, i32 %w.059, i32 %c.058
  %1 = load i32, i32* %arrayidx15, align 4, !tbaa !3
  %add16.1 = add i32 %0, %1
  %arrayidx15.161 = getelementptr inbounds [28 x [6 x i32]], [28 x [6 x i32]]* %poolIn, i32 %add.1, i32 %w.059, i32 %c.058
  %2 = load i32, i32* %arrayidx15.161, align 4, !tbaa !3
  %add16.162 = add i32 %2, %add16.1
  %add13.1.1 = or i32 %w.059, 1
  %arrayidx15.1.1 = getelementptr inbounds [28 x [6 x i32]], [28 x [6 x i32]]* %poolIn, i32 %add.1, i32 %add13.1.1, i32 %c.058
  %3 = load i32, i32* %arrayidx15.1.1, align 4, !tbaa !3
  %add16.1.1 = add i32 %3, %add16.162
  %div = sdiv i32 %add16.1.1, 4
  %arrayidx24 = getelementptr inbounds [14 x [6 x i32]], [14 x [6 x i32]]* %poolOut, i32 %div20, i32 %div22, i32 %c.058
...
entry:
  call void @compute([28 x [6 x i32]]* nonnull inttoptr (i32 268590464 to [28 x [6 x i32]]*), [14 x [6 x i32]]* nonnull inttoptr (i32 268609344 to [14 x [6 x i32]]*))
  ret void
}
